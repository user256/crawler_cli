...
class AnalyticsDetector:
    ...
    _SCRIPT_PATTERNS: list[tuple[str, str, str, re.Pattern[str], re.Pattern[str] | None, float]] = [
        ...
        (
            ...
            "tag_manager",
            "script_src",
            re.compile(r"googletagmanager\.com/gtm\.js\?id=(GTM-[A-Z0-9]+)"),
            None,
            1.0,
        ),
        (
            ...
            "tag_manager",
            "script_src",
            re.compile(r"googletagmanager\.com/gtag/js\?id=(GTM-[A-Z0-9]+)"),
            None,
            0.95,
        ),
        ...
        (
            ...
            "tag_manager",
            "script_src",
            re.compile(r"tags\.tiqcdn\.com/utag/[^/]+/[^/]+/[^/]+/utag\.js"),
            re.compile(r"tags\.tiqcdn\.com/utag/([^/]+/[^/]+/[^/]+)/utag\.js"),
            1.0,
        ),
        (
            ...
            "tag_manager",
            "script_src",
            re.compile(r"cdn\.segment\.com/analytics\.js/v1/[^/]+/analytics\.min\.js"),
            re.compile(r"cdn\.segment\.com/analytics\.js/v1/([^/]+)/analytics\.min\.js"),
            1.0,
        ),
        ...
        (
            ...
            "tag_manager",
            "script_src",
            re.compile(r"/js/container_([a-zA-Z0-9_-]+)\.js"),
            None,
            1.0,
        ),
        ...
        (
            ...
            "analytics",
            "script_src",
            re.compile(r"googletagmanager\.com/gtag/js\?id=(AW-[A-Z0-9]+)"),
            None,
            1.0,
        ),
        (
            ...
            "analytics",
            "script_src",
            re.compile(r"googletagmanager\.com/gtag/js\?id=(DC-[A-Z0-9]+)"),
            None,
            1.0,
        ),
        ...
        (
            ...
            "analytics",
            "script_src",
            re.compile(r"static\.cloudflareinsights\.com/beacon\.min\.js"),
            None,
            1.0,
        ),
        (
            ...
            "analytics",
            "script_src",
            re.compile(r"scripts\.simpleanalyticscdn\.com/latest\.js"),
            None,
            1.0,
        ),
        ...
        (
            ...
            "pixel",
            "script_src",
            re.compile(r"snap\.licdn\.com/li\.lms-analytics/insight\.min\.js"),
            None,
            1.0,
        ),
        ...
        (
            ...
            "ab_test",
            "script_src",
            re.compile(r"optimize\.google\.com/optimize\.js\?id=(OPT-[A-Z0-9]+)"),
            None,
            1.0,
        ),
    ...
    _NOSCRIPT_PATTERNS: list[tuple[str, str, str, re.Pattern[str], re.Pattern[str] | None, float]] = [
        (
            ...
            "tag_manager",
            "noscript_iframe",
            re.compile(r"googletagmanager\.com/ns\.html\?id=(GTM-[A-Z0-9]+)"),
            None,
            0.95,
        ),
    ]
    ...
    _INLINE_PATTERNS: list[tuple[str, str, str, re.Pattern[str], re.Pattern[str] | None, float]] = [
        ...
        (
            ...
            "analytics",
            "inline_js",
            re.compile(r"ga\(['\"]create['\"],\s*['\"](UA-\d+-\d+)['\"]"),
            None,
            0.95,
        ),
