...
from .exit_codes import EXIT_CHECK_FAILED, EXIT_VALIDATION, resolve_crawl_exit_code
...
async def _run_compare_urls(args: argparse.Namespace) -> int:
    ...
    if args.fail_on:
        ...
        if failures:
            ...
            # Distinct from EXIT_VALIDATION so CI can tell a tripped gate from a
            # malformed command line (ticket 123).
